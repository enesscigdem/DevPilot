...
public class RepositoryCloneServiceTests : IDisposable
{
    ...
    [InlineData("git@github.com:enesscigdem/DevPilot", "enesscigdem", "DevPilot", true)]
    [InlineData("ssh://git@github.com/enesscigdem/DevPilot.git", "enesscigdem", "DevPilot", true)]
    [InlineData("ssh://git@github.com:22/enesscigdem/DevPilot.git", "enesscigdem", "DevPilot", true)]
