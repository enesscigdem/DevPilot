...
namespace DevPilot.Infrastructure.Migrations
{
    ...
    [Migration("20260820162118_AddProjectBrainConversationHistory")]
    partial class AddProjectBrainConversationHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevPilot.Domain.Entities.GitHubInstallationConnection", b =>
                {
                    ...
                    b.HasIndex("ExternalInstallationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("DevPilot.Domain.ProjectBrain.Entities.ProjectBrainConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RepositoryWorkspaceId", "UpdatedAt");

                    b.ToTable("ProjectBrainConversations");
                });

            modelBuilder.Entity("DevPilot.Domain.ProjectBrain.Entities.ProjectBrainMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ContextFilesJson")
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("ProjectBrainMessages");
                });
            ...
            modelBuilder.Entity("DevPilot.Domain.ProjectBrain.Entities.ProjectBrainConversation", b =>
                {
                    b.HasOne("DevPilot.Domain.Entities.RepositoryWorkspace", null)
                        .WithMany()
                        .HasForeignKey("RepositoryWorkspaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DevPilot.Domain.ProjectBrain.Entities.ProjectBrainMessage", b =>
                {
                    b.HasOne("DevPilot.Domain.ProjectBrain.Entities.ProjectBrainConversation", "Conversation")
                        .WithMany("Messages")
